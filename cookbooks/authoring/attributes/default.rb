default['wp-authoring']['nginx']['tenantName'] = "default-tenant"
...
default['wp-authoring']['deploy']['plugins'] = [ "content-transformer" , "Plugin-CustomField", "utility-client" ]
...
default['wp-authoring']['php']['common_rpm_name'] = "php71w-common-7.1.5-1.w7.x86_64.rpm"
default['wp-authoring']['php']['fpm_rpm_name'] = "php71w-fpm-7.1.5-1.w7.x86_64.rpm"
default['wp-authoring']['php']['pdo_rpm_name'] = "php71w-pdo-7.1.5-1.w7.x86_64.rpm"
default['wp-authoring']['php']['mysql_rpm_name'] = "php71w-mysqlnd-7.1.5-1.w7.x86_64.rpm"
